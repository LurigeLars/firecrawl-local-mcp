// Offline test of the gateway's Cloudflare Access JWT checks. Usage: node public/access-test.mjs file:///C:/path/to/firecrawl-local/public/gateway/gateway.mjs
