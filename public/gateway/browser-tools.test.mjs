...
assert.equal(BROWSER_TOOL_DEFINITIONS.length, 4);
assert.deepEqual([...BROWSER_TOOL_NAMES].sort(), ['browser_network_log','browser_session_open','browser_session_status','browser_snapshot']);
