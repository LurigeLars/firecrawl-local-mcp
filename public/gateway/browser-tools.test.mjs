...
assert.deepEqual([...BROWSER_TOOL_NAMES].sort(), ['browser_network_log','browser_product_open','browser_product_probe','browser_session_open','browser_session_status','browser_snapshot']);
